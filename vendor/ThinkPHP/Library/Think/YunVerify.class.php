...
class YunVerify
{
    ...
    private static $id = "AKIDIhWnlCRMFdXzzRuyzWY7Es5mzm3znEWM";
 // 开发商的ID，用于检索KEY
    private static $key = "SMjvNQyxYeILz8p3o6sAtD3NCYNiZz1Z";
 // 开发商的KEY，用于传输数据进行签名加密以及解密
    private static $buid = "";
 // 使用验证码的业务，用于生成统计数据，如果不区分则为空
    private static $sceneid = "";
 // 使用验证码的场景，用于生成统计数据，如果不区分则为空
    private static $uid = "";
 // 用户UID，如果不区分用户则为空
    private static $captype = "2";
 // 验证码类型，具体说明可参考开发手册
    private static $callback = "";
 // query接口的回调函数
    private static $version = "v1";
 // 接口版本
    private static $ip = "api.guard.qcloud.com";
 // 验证码服务IP
