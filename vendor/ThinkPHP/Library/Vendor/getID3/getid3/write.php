...
class getid3_writetags
{
 ...
 // array of tag formats to write ('id3v1', 'id3v2.2', 'id2v2.3', 'id3v2.4', 'ape', 'vorbiscomment', 'metaflac', 'real')
 ...
 // ISO-639-2 3-character language code needed for some ID3v2 frames (http://www.id3.org/iso639-2.html)
 ...
 // analysis of file before writing
    ...
    public function FormatDataForID3v2($id3v2_majorversion)
    {
        ...
        $ID3v2_text_encoding_lookup[2] = array(
            'ISO-8859-1' => 0,
            'UTF-16' => 1
        );
        $ID3v2_text_encoding_lookup[3] = array(
            'ISO-8859-1' => 0,
            'UTF-16' => 1
        );
        $ID3v2_text_encoding_lookup[4] = array(
            'ISO-8859-1' => 0,
            'UTF-16' => 1,
            'UTF-16BE' => 2,
            'UTF-8' => 3
