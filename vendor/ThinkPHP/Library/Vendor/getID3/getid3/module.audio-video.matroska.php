...
class getid3_matroska extends getid3_handler
{
 ...
 // true to parse the whole file, not only header [default: FALSE]
    ...
    private $unuseful_elements = array(
        EBML_ID_CRC32,
        EBML_ID_VOID
    );
                                                        ...
                                                        while ($this->getEBMLelement($sub_subelement, $subelement['end'])) {
                                                            switch ($sub_subelement['id']) {
                                                                ...
                                                                case EBML_ID_CONTENTENCODING:
                                                                    ...
                                                                    while ($this->getEBMLelement($sub_sub_subelement, $sub_subelement['end'], array(
                                ...
                                while ($this->getEBMLelement($subelement, $element_data['end'])) {
                                    switch ($subelement['id']) {
                                        ...
                                        case EBML_ID_CUEPOINT:
                                            ...
                                            while ($this->getEBMLelement($sub_subelement, $subelement['end'], array(
    ...
    private function HandleEMBLSimpleTag($parent_end)
    {
        ...
        while ($this->getEBMLelement($element, $parent_end, array(
            EBML_ID_SIMPLETAG
        ))) {
            switch ($element['id']) {
