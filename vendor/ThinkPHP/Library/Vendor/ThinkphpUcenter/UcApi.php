...
class UcApi
{
    ...
    public static function login($username, $password, $isuid = 0)
    {
    ...
    public static function reg($username, $password, $email, $autologin = false)
    {
        $ip = get_client_ip();
    ...
    public static function addFeed($uid, $username, $url, $where, $action, $event, $desc, $images = array())
    {
        $feed = array();
        $feed['icon'] = 'thread';
