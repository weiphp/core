...
class VoteOptionModel extends Model
{
    ...
    public function set($vote_id, $post)
    {
    ...
    // 获取信息
    public function getList($vote_id, $update = false, $list = array())
    {
    ...
    // 通用的清缓存的方法
    public function clear($vote_ids, $type = '', $uid = '')
    {
    ...
    // 素材相关
    public function getSucaiList($search = '')
    {
        $map['token'] = get_token();
        $map['uid'] = session('mid');
    ...
    public function getPackageData($vote_id)
    {
    ...
    public function updateOptCount($vote_id, $ids)
    {
