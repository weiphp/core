...
class quickpay_service
{
 ...
 // 查询成功
    ...
    public function quickpay_service($args, $service)
    {
    ...
    public function __construct($args, $service)
    {
        ...
        switch ($service) {
            case quickpay_conf::FRONT_PAY:
                ...
                $this->args = array_merge(quickpay_conf::$pay_params_empty, quickpay_conf::$pay_params, $args);
            ...
            case quickpay_conf::QUERY:
                ...
                if (empty(quickpay_conf::$pay_params['merId']) && empty(quickpay_conf::$pay_params['acqCode'])) {
