...
class quickpay_conf
{
 ...
 // 时区
    public static $sign_method = "md5";
 // 摘要算法，目前仅支持md5 (2011-08-22)
    public static $security_key = "88888888";
 // 商户密钥
                                                 
    // 支付请求预定义字段
    public static $pay_params = array(
        'version' => '1.0.0',
    ...
    // 支付请求可为空字段（但必须填写）
    public static $pay_params_empty = array(
        "origQid" => "",
        "acqCode" => "",
        "merCode" => "",
        "commodityUrl" => "",
    ...
    // 支付请求必填字段检查
    public static $pay_params_check = array(
        "version",
        "charset",
        "transType",
        "origQid",
    ...
    // 查询请求必填字段检查
    public static $query_params_check = array(
        "version",
        "charset",
        "transType",
        "merId",
    ...
    // 商户保留域可能包含的字段
    public static $mer_params_reserved = array(
        // NEW NAME OLD NAME
        "cardNumber",
        "pan",
        "cardPasswd",
    ...
    public static $notify_param_check = array(
        "version",
        "charset",
        "transType",
        "respCode",
    ...
    public static $sign_ignore_params = array(
        "bank"
    );
}
