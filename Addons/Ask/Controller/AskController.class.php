...
class AskController extends AddonsController
{
    ...
    // 判断答题是否正确
    public function _checkAnswer($question, $answer)
    {
        if (! is_array($answer)) {
            $answer = array(
                $answer
    ...
    public function wait($html = 'wait')
    {
        /*
