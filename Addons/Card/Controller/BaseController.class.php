...
class BaseController extends AddonsController
{
    ...
    public function _initialize()
    {
        ...
        $res['title'] = '会员卡设置';
        $res['url'] = addons_url('Card://Card/config', array(
            'mdm' => I('mdm')
        ));
        ...
        $res['title'] = '会员管理';
        $res['url'] = addons_url('Card://member/lists', array(
            'mdm' => I('mdm')
        ));
        ...
        $res['title'] = '会员交易';
        $res['url'] = addons_url('Card://MemberTransition/lists', array(
            'mdm' => I('mdm')
        ));
        $res['class'] = $controller == 'membertransition' ? 'current' : '';
        $nav[] = $res;
        $res['title'] = '会员营销';
        $res['url'] = addons_url('Card://MemberMarketing/lists', array(
            'mdm' => I('mdm')
        ));
        $res['class'] = $controller == 'membermarketing' ? 'current' : '';
        $nav[] = $res;
        $res['title'] = '通知管理';
        $res['url'] = addons_url('Card://Notice/lists', array(
            'mdm' => I('mdm')
        ));
        $res['class'] = $controller == 'notice' ? 'current' : '';
        $nav[] = $res;
        $res['title'] = '数据统计';
        $res['url'] = addons_url('Card://Tongji/index', array(
            'mdm' => I('mdm')
        ));
