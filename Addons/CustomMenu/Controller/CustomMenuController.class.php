...
class CustomMenuController extends AddonsController
{
    ...
    public function _deal_post($data)
    {
            ...
            switch ($addon) {
                ...
                default:
                    ...
                    if ($addon == 'Vote') {
                        $param_name = 'vote_id';
                        $addon = 'ShopVote';
                    } elseif ($addon == 'HelpOpen') {
                        $status = 'status';
                    } elseif ($addon == 'Reserve') {
    ...
    public function get_addons_lists_url()
    {
        ...
        } elseif ($addonName == 'Draw') {
            $url = addons_url('Draw://Games/lists');
        } elseif ($addonName == 'Shop') {
            $url = '';
            // 获取当前登录的用户的商城
            $map['token'] = get_token();
            $map['manager_id'] = $this->mid;
    ...
    public function get_addons_name()
    {
    ...
    public function get_addon_jump_url()
    {
        $addonName = I('addon_name');
        $id = I('id');
