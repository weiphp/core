...
class WapController extends AddonsController
{
    ...
    public function index()
    {
        ...
        $fields = M('reserve_attribute')->where($map2)
        ...
        // 获取预约项
        $option_list = M('reserve_option')->where($map2)
            ->order('id asc')
            ->select();
    ...
    public function reserve_success()
    {
        ...
        $map3['uid'] = $this->mid;
        $valueArr = M('reserve_value')->where($map3)
            ->field('id,value,is_pay')
            ->find();
    ...
    public function scan_success()
    {
        ...
        $map3['uid'] = $uid;
        $value = M('reserve_value')->where($map3)
            ->field('id,value,is_pay')
            ->find();
        $is_pay = $value['is_pay'];
