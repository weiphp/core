...
class WeibaController extends AddonsController
{
    ...
    public function lists()
    {
        ...
        $this->assign('normal_tips', '微社区首页链接:' . addons_url('Weiba://Wap/index', array(
            'publicid' => $public_id
        )) . '&nbsp;&nbsp;&nbsp;<a class="btn" style="padding:2px 10px" id="copyLink" href="javascript:;" data-clipboard-text="' . addons_url('Weiba://Wap/index', array(
            'publicid' => $public_id
        )) . '">复制链接</a><script>$.WeiPHP.initCopyBtn(\'copyLink\');
</script>');
        $map['token'] = get_token();
