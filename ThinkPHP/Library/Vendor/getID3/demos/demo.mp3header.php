...
if (! function_exists('RemoveAccents')) {
    ...
    function RemoveAccents($string)
    {
        ...
        return strtr(strtr($string, 'ÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÑÒÓÔÕÖØÙÚÛÜÝàáâãäåçèéêëìíîïñòóôõöøùúûüýÿ', 'SZszYAAAAAACEEEEIIIINOOOOOOUUUUYaaaaaaceeeeiiiinoooooouuuuyy'), array(
            'Þ' => 'TH',
            'þ' => 'th',
            'Ð' => 'DH',
            'ð' => 'dh',
...
if (isset($_POST['Analyze']) && $_POST['HeaderHexBytes']) {
    ...
    $MPEGaudioBitrateLookup['1']['I'] = array(
        'free' => '0000',
        '32' => '0001',
        '64' => '0010',
        '96' => '0011',
    ...
    $MPEGaudioBitrateLookup['1']['II'] = array(
        'free' => '0000',
        '32' => '0001',
        '48' => '0010',
        '56' => '0011',
    ...
    $MPEGaudioBitrateLookup['1']['III'] = array(
        'free' => '0000',
        '32' => '0001',
        '40' => '0010',
        '48' => '0011',
    ...
    $MPEGaudioBitrateLookup['2']['I'] = array(
        'free' => '0000',
        '32' => '0001',
        '48' => '0010',
        '56' => '0011',
    ...
    $MPEGaudioBitrateLookup['2']['II'] = array(
        'free' => '0000',
        '8' => '0001',
        '16' => '0010',
        '24' => '0011',
    ...
    $MPEGaudioFrequencyLookup['1'] = array(
        '44100' => '00',
        '48000' => '01',
        '32000' => '10'
    );
    $MPEGaudioFrequencyLookup['2'] = array(
        '22050' => '00',
        '24000' => '01',
        '16000' => '10'
    );
    $MPEGaudioFrequencyLookup['2.5'] = array(
        '11025' => '00',
        '12000' => '01',
        '8000' => '10'
    );
    ...
    $MPEGaudioModeExtensionLookup['I'] = array(
        '4-31' => '00',
        '8-31' => '01',
        '12-31' => '10',
        '16-31' => '11'
    ...
    $MPEGaudioModeExtensionLookup['III'] = array(
        'none' => '00',
        'IS' => '01',
        'MS' => '10',
        'IS+MS' => '11'
...
function MPEGaudioModeExtensionLookup($layer, $rawmodeextension)
{
    ...
    $MPEGaudioModeExtensionLookup['II'] = array(
        '4-31',
        '8-31',
        '12-31',
        '16-31'
...
function RecursiveFrameScanning(&$fd, &$ThisFileInfo, &$offset, &$nextframetestoffset, $ScanAsCBR)
{
    for ($i = 0; $i < MPEG_VALID_CHECK_FRAMES; $i ++) {
        ...
        $nextframetestarray = array(
            'error' => '',
            'warning' => '',
            'avdataend' => $ThisFileInfo['avdataend'],
    ...
    while (true) {
        ...
        if (($header{$SynchSeekOffset} == CONST_FF) && ($header{($SynchSeekOffset + 1)} > CONST_E0)) { // synch detected
            ...
            if (decodeMPEGaudioHeader($fd, $avdataoffset + $SynchSeekOffset, $dummy, true)) {
                ...
                if ($BitrateHistogram) {
                    $ThisFileInfo['mpeg']['audio']['stereo_distribution'] = array(
                        'stereo' => 0,
                        'joint stereo' => 0,
                        'dual channel' => 0,
                        'mono' => 0
                    );
                    $ThisFileInfo['mpeg']['audio']['version_distribution'] = array(
                        '1' => 0,
                        '2' => 0,
                        '2.5' => 0
                    );
                    ...
                    if ($ThisFileInfo['mpeg']['audio']['version'] == '1') {
                        if ($ThisFileInfo['mpeg']['audio']['layer'] == 'III') {
                            $ThisFileInfo['mpeg']['audio']['bitrate_distribution'] = array(
                                'free' => 0,
                                32 => 0,
                                40 => 0,
                                48 => 0,
                    ...
                    $dummy = array(
                        'error' => $ThisFileInfo['error'],
                        'warning' => $ThisFileInfo['warning'],
                        'avdataend' => $ThisFileInfo['avdataend'],
                        'avdataoffset' => $ThisFileInfo['avdataoffset']
                    );
...
function MPEGaudioFrequencyArray()
{
    ...
    if (empty($MPEGaudioFrequency)) {
        $MPEGaudioFrequency['1'] = array(
            44100,
            48000,
            32000
        );
        $MPEGaudioFrequency['2'] = array(
            22050,
            24000,
            16000
        );
        $MPEGaudioFrequency['2.5'] = array(
            11025,
            12000,
            8000
        );
...
{
    static $MPEGaudioChannelMode = array(
        'stereo',
        'joint stereo',
        'dual channel',
        'mono'
...
function MPEGaudioModeExtensionArray()
{
    ...
    if (empty($MPEGaudioModeExtension)) {
        $MPEGaudioModeExtension['I'] = array(
            '4-31',
            '8-31',
            '12-31',
            '16-31'
        );
        $MPEGaudioModeExtension['II'] = array(
            '4-31',
            '8-31',
            '12-31',
            '16-31'
        );
        $MPEGaudioModeExtension['III'] = array(
            '',
            'IS',
            'MS',
            'IS+MS'
...
{
    static $MPEGaudioEmphasis = array(
        'none',
        '50/15ms',
        false,
        'CCIT J.17'
