...
class dirscan
{
     ...
     *            directory to use
     * @param
     *            mixed cvs list of extentions or an array
     ...
     * @param type $dir            
     * @param type $match
     *            search type name extentions, can be an array or csv list
     * @param type $cache
     *            caching extention, select one of sqlite3, mysql, dbm
     * @param array $opt
     *            database options,
     */
    public function scan_files($dir, $match, $cache = 'sqlite3', $opt = array('table'=>'getid3_cache', 'hide'=>true))
    {
        $Start = self::getTime();
