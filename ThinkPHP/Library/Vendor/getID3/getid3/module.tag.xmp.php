...
class Image_XMP
{
    ...
    /**
     *
     * @var string The name of the image file that contains the XMP fields to extract and modify.
     * @see Image_XMP()
     */
    ...
    /**
     *
     * @var array The XMP fields that were extracted from the image or updated by this class.
     * @see getAllTags()
     */
    public $_aXMP = array();
    ...
    /**
     *
     * @var boolean True if an APP1 segment was found to contain XMP metadata.
     * @see isValid()
     */
     ...
     *
     * @return boolean Returns true if an APP1 segment was found to contain XMP metadata.
     */
