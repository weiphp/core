...
if ($open_basedir) {
    ...
    $temp_dir = str_replace(array(
        '/',
        '\\'
    ), DIRECTORY_SEPARATOR, $temp_dir);
 ...
 // Result array.
    ...
    public function analyze($filename, $filesize = null, $original_filename = '')
    {
        try {
            ...
            if (! empty($determined_format['iconv_req']) && ! function_exists('iconv') && ! in_array($this->encoding, array(
                'ISO-8859-1',
                'UTF-8',
                'UTF-16LE',
                'UTF-16BE',
