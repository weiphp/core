...
class AddonsController extends Controller
{
    ...
    // WAP页面的通用分页HTML
    public function _wapPage($count, $row)
    {
        if ($count <= $row) {
            return '';
        }
    ...
    public function get_package_template()
    {
        $addons = I('addons');
        /*
    ...
    public function getSucaiTemplateInfo()
    {
        $addons = I('addons');
        $template = I('template');
    ...
    public function _readSucaiTemplateInfo($addons = 'Coupon', $template = 'default')
    {
