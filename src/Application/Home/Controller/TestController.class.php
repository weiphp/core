...
class TestController extends HomeController
{
 ...
 // 源数据库
    ...
    public function adddel($table, $field)
    {
        set_time_limit(0);
...
str;
    ...
    public function updateNotNull2()
    {
