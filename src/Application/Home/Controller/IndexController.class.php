...
class IndexController extends HomeController
{
    ...
    public function index()
    {
        ...
        } elseif ($user['is_audit'] == 0 && ! C('REG_AUDIT')) {
    ...
    public function update_json()
    {
        ...
        if ($old_version < $new_version) {
            $res = M('update_version')->field('version,title,description,create_date')
    ...
    public function main()
    {
        ...
        $count['total'] = M()->where($map)
            ->table($px . 'public_follow as f')
            ->count();
        ...
        $count['today'] = M()->table($px . 'public_follow as f')
        ...
        $count['yestoday'] = M()->table($px . 'public_follow as f')
            ->join($px . 'user as u ON f.uid=u.uid')
            ->where($map)
            ->count();
