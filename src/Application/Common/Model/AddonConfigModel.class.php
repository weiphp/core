...
class AddonConfigModel extends Model
{
     ...
     * 保存配置
     */
    public function set($addon, $config)
    {
        $map['token'] = get_token();
        if (empty($map['token'])) {
            return false;
    ...
    public function sett($addon, $config, $id)
    {
        $map['token'] = get_token();
        $map['id'] = $id;
        if (empty($map['token'])) {
    ...
    public function setlist($addon, $config, $id)
    {
        $map['token'] = get_token();
        $map['id'] = $id;
        if (empty($map['token'])) {
    ...
    public function setdetail($addon, $config, $id)
    {
        $map['token'] = get_token();
        $map['id'] = $id;
        if (empty($map['token'])) {
    ...
    public function setfooter($addon, $config, $id)
    {
        $map['token'] = get_token();
        $map['id'] = $id;
        if (empty($map['token'])) {
