...
class PublicModel extends Model
{
    ...
    public function getInfo($id, $filed = '', $update = false, $data = array())
    {
        if (empty($id)) {
    ...
    public function getInfoByToken($token, $filed = '', $update = false)
    {
    ...
    public function clear($id, $type = '', $uid = '')
    {
    ...
    public function getMyPublics($uid)
    {
        $map['uid'] = $uid;
