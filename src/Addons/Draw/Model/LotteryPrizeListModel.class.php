...
class LotteryPrizeListModel extends Model
{
    ...
    // 根据场次编号获取奖品
    public function getList($sportsId, $update = false)
    {
    ...
    public function set($sports_id, $post)
    {
    ...
    public function getCountInfo($sports_id, $award_id, $update = false, $data = array())
    {
    ...
    // 兑换时奖品数量-1
    public function setCount($sports_id, $award_id)
    {
        $map['sports_id'] = $sports_id;
        $map['award_id'] = $award_id;
    ...
    // 添加数据
    public function delayAddData($datas)
    {
