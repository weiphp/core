...
class SurveyAnswerModel extends Model
{
    ...
    public function getAnswerInfo($survey_id, $question_id, $follow_id, $update = false, $data = array())
    {
    ...
    public function updateAnswer($survey_id, $question_id, $follow_id, $data = array())
    {
        $map['survey_id'] = $survey_id;
        $map['question_id'] = $question_id;
        $map['uid'] = $follow_id;
