...
class ReserveController extends AddonsController
{
    ...
    public function edit()
    {
        ...
        if (IS_POST) {
            ...
            // 预约项信息
            $map['reserve_id'] = $id;
            $list = M('reserve_option')->where($map)
                ->order('id asc')
                ->select();
            $this->assign('option_list', $list);
            
            // 字段信息
            $list = M('reserve_attribute')->where($map)
                ->order('sort asc')
                ->select();
    ...
    // 保存字段信息
    public function _setAttr($reserve_id, $data)
    {
    ...
    // 保存预约项信息
    public function _setOption($reserve_id, $data)
    {
    ...
    public function index()
    {
        ...
        $map['reserve_id'] = $this->reserve_id;
        $map['token'] = get_token();
        $fields = M('reserve_attribute')->where($map)
