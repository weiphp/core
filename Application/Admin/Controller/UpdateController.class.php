...
class UpdateController extends AdminController
{
    ...
    // 下载更新包
    public function step02_download()
    {
    ...
    // 解压更新包
    public function step03_unzipPackage()
    {
        Vendor('Update');
        $updateClass = new \Update();
    ...
    // 检查要覆盖的文件的可写权限和md5码
    public function step04_checkFileIsWritable()
    {
    ...
    // 自动更新数据库
    public function step07_dealSQL()
    {
        // $this->closeSite();
    ...
    // 自动覆盖文件
    public function step06_overWritten()
    {
        // 提示需要删除的文件
    ...
    public function step08_finishUpate()
    {
        // 清除缓存
        $this->cleanCache();
    ...
    // 更新本地的授权信息
    public function save_store_license()
    {
